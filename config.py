"""
Production-ready configuration management for Educational Tutor Agent
"""
...
class ProductionConfig:
    ...
    MAX_DATASET_SIZE: int = 1000  # Increased for production
    
    # Generation settings
    MAX_NEW_TOKENS: int = 512  # Increased for detailed answers
    MIN_LENGTH: int = 50
